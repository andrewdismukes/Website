...
_Update November 2018: You now need to apply for a developer account to get a twitter API token._ 
...
```{r eval=FALSE, include=FALSE}
setup_twitter_oauth("cyclIAfbzpZkxe6DXXG0aVFTn", 
                    "OCviXUFqGOJSVKurfhfuawuzymM70VIpriSAnyX3wCtvysEPjg",
                    "4281165078-3THeVdzS71z6Ay7brl78hcDQfJdddKWn0bDSCYQ",
                    "pA5kk30pD9VjG4gruZ0Jr9rDIArfSCKksv1L24P7UtICb")
